            ...
            <div class="card post-bg">
                <ul style="margin-top: 3rem;">
                    ...
                    <li class="d-flex justify-content-center total-post"><span style="margin-right: 0.3rem;"> Total ads</span>
                        ...
                        $sql = "select count(id) from donate";
                    ...
                    $sql = "select * from donate order by id desc limit " . $this_page_first_result . "," . $results_per_page;
                            ...
                            <li class="card card-li">
                                ...
                                <div class="post-head">
                                    <ul class="inline-list-head">
                                        ...
                                        <li>
                                            <?php
                                            echo "<span class='btn btn-sm price'>*</span>";
                                            ?>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="post-image-container">
                                    <?php
                                    echo "<img class='post-image' src='includes/donate/" . $row['image'] . "' >";
                                    ?>
                                </div>
                                <div class="post-footer">
                                    <ul class="inline-list">
                                        ...
                                        <li>
                                            <a href="donate-order.php?id=<?php echo $id ?>" style="padding-left: 1rem; padding-right: 1rem;" class="btn btn-sm btn-md">Apply</a>
                                        </li>
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        $page = end($break);
                        if ($page > 1) {
                            echo '<li class="page-item"><a class="page-link" href="donate-ads.php?page=' . ((int)$page - 1) . '">Previous</a></li>';
                        }
                    }
                    for ($page = 1; $page <= $number_of_pages; $page++) {
                        echo '<li class="page-item"><a class="page-link" href="donate-ads.php?page=' . $page . '">' . $page . '</a></li> ';
                    }
                    if (isset($_GET['page'])) {
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        if ((int)$page < $number_of_pages) {
                            echo '<li class="page-item"><a class="page-link" href="donate-ads.php?page=' . ((int)$page + 1) . '">Next</a></li>';
                        }
