        ...
        <div class="col-sm-8 post-container d-flex justify-content-center">
            <div class="card post-bg">
                <ul style="margin-top: 3rem;">
                    ...
                    <li class="d-flex justify-content-center total-post"><span style="margin-right: 0.3rem;"> Total ads</span>
                        ...
                        if (isset($_GET['department'])) {
                            if ($_GET['department'] == 'eee')
                                $dept = 'eee';
                            else if ($_GET['department'] == 'cse')
                                $dept = 'cse';
                            else if ($_GET['department'] == 'ece')
                                $dept = 'ece';
                            else if ($_GET['department'] == 'ete')
                                $dept = 'ete';
                            else if ($_GET['department'] == 'ce')
                                $dept = 'ce';
                            else if ($_GET['department'] == 'arch')
                                $dept = 'arch';
                            else if ($_GET['department'] == 'becm')
                                $dept = 'becm';
                            else if ($_GET['department'] == 'urp')
                                $dept = 'urp';
                            else if ($_GET['department'] == 'me')
                                $dept = 'me';
                            else if ($_GET['department'] == 'ipe')
                                $dept = 'ipe';
                            else if ($_GET['department'] == 'mte')
                                $dept = 'mte';
                            else if ($_GET['department'] == 'gce')
                                $dept = 'gce';
                            else if ($_GET['department'] == 'mse')
                                $dept = 'mse';
                            else if ($_GET['department'] == 'cfpe')
                                $dept = 'cfpe';
                        ...
                        $sql = "select count(id) from posts where department = '$dept'";
                    ...
                    if ($total_users > 0) {
                        $results_per_page = 5;
                        $sql = "select * from posts where department = '$dept' order by id desc";
                        ...
                        $sql = "select * from posts where department = '$dept' order by id desc limit " . $this_page_first_result . "," . $results_per_page;
                        $res = mysqli_query($con, $sql);
                    ...
                    <?php
                        ...
                        if (isset($_GET['page'])) {
                            ...
                            $page = end($break);
                            if ($page > 1) {
                                echo '<li class="page-item"><a class="page-link" href="dept-ads.php?page=' . ((int)$page - 1) . '">Previous</a></li>';
                            }
                        }
                        for ($page = 1; $page <= $number_of_pages; $page++) {
                            echo '<li class="page-item"><a class="page-link" href="dept-ads.php?page=' . $page . '">' . $page . '</a></li> ';
                        }
                        if (isset($_GET['page'])) {
                        ...
                        if (isset($_GET['page'])) {
                            ...
                            if ((int)$page < $number_of_pages) {
                                echo '<li class="page-item"><a class="page-link" href="dept-ads.php?page=' . ((int)$page + 1) . '">Next</a></li>';
                            }
                        ...
                        echo "<div style='margin: 6rem 2rem;'>No posts yet from this department!</div>";
                    }
