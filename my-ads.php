        ...
        <div class="col-sm-8 post-container d-flex justify-content-center">
            <div class="card post-bg">
                <ul style="margin-top: 3rem;">
                    ...
                    <li class="d-flex justify-content-center total-post"><span style="margin-right: 0.3rem;"> My Posts</span>
                        <?php
                        require_once 'includes/db.php';


                        $sql = "select count(id) from posts where username = '" . $_SESSION['username'] . "'";

                        $result = mysqli_query($con, $sql);
                        $total_ads = $result->fetch_array()[0] ?? '';
                        echo "<span class='badge badge-pill badge-dark'>$total_ads</span>";
                    ...
                    $sql = "select * from posts where username = '" . $_SESSION['username'] . "' order by id desc limit " . $this_page_first_result . "," . $results_per_page;
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        $page = end($break);
                        if ($page > 1) {
                            echo '<li class="page-item"><a class="page-link" href="my-ads.php?page=' . ((int)$page - 1) . '">Previous</a></li>';
                        }
                    }
                    for ($page = 1; $page <= $number_of_pages; $page++) {
                        echo '<li class="page-item"><a class="page-link" href="my-ads.php?page=' . $page . '">' . $page . '</a></li> ';
                    }
                    if (isset($_GET['page'])) {
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        if ((int)$page < $number_of_pages) {
                            echo '<li class="page-item"><a class="page-link" href="my-ads.php?page=' . ((int)$page + 1) . '">Next</a></li>';
                        }
